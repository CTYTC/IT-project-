...
articleRouter.get('/subtitle', (req, res) => articleController.getSubtitle(req, res));
articleRouter.post('/updateSubTitle', (req,res)=>articleController.updateModuleTitle(req, res));
